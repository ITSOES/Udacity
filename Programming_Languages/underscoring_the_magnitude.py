...
def t_STRING(token):
    r'\'.*?\'|".*?"'
    token.value = token.value.strip(token.value[0])
    token.type = 'STRING'
    return token
...
ans2 = test_lexer(question2)
print ans2 == answer2

question3 = """ 12_34 5_6_7_8 0______1 1234 """
answer3 = [('NUMBER', 1234), ('NUMBER', 5678), ('NUMBER', 1), ('NUMBER', 1234)]
ans3 = test_lexer(question3)
print ans3 == answer3


question4 = """ 'he'llo w0rld 33k """
answer4 = [('STRING', 'he'), ('IDENT', 'llo'), ('IDENT', 'w'),
           ('NUMBER',0), ('IDENT', 'rld'), ('NUMBER', 33), ('IDENT', 'k')]
ans4 = test_lexer(question4)
print ans4 == answer4